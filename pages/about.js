  ...
  if (loading) {
    ...
    <div class="flex flex-wrap items-center sm:-mx-3">
      <div class="w-full md:w-1/2 md:px-3">
        <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
            <span class="block xl:inline text-[#308C8F]">LOOP keeps you up with what's going on in the Metro,</span>
      ...
      <div class="w-full md:w-1/2">
        <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
            <img src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2F5.jpg?alt=media&token=6c169f27-9bcc-4c88-914a-787249cc4f45"></img>
          </div>
      </div>
    </div>
  </div>
    ...
    <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
        ...
        <div class="box-border relative w-full max-w-md px-4 mt-5 mb-4 -ml-5 text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0 md:w-1/2 xl:pl-10">
            <img src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2FSecurity.png?alt=media&token=be7523ae-ffa7-4b8d-874d-d1a613f30c5a" class="p-2 pl-6 pr-5 xl:pl-16 xl:pr-20 "></img>
        </div>
    ...
    <div class="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
        ...
        <div class="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
            ...
            Through LOOP, we look forward to giving real-time and reliable information, particularly addressing relevant incidents such as crime, accidents, missing persons, or disasters inside the National Capital Region (NCR).
            </p>

        </div>

        <div class="box-border relative w-full max-w-md px-4 mt-10 mb-4 text-center bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2">
            <img src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2Ftechnology.png?alt=media&token=0c721202-a9c4-4875-b555-73a4a13a388b" class="pl-4 sm:pr-10 xl:pl-10 lg:pr-32"></img>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2Fmember_antonio.png?alt=media&token=f7f7e43f-3c32-4774-ab64-159f33f9a969"></img>
                    <h2 class="text-lg font-medium">CINCO, Glenn Marcus D.</h2>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2Fmember_jm.png?alt=media&token=eb680c16-ce08-4b59-97d1-354068ae380a"></img>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2Fmember_jc.png?alt=media&token=7b9f51c4-8b6c-4417-8048-44f7117ca3f8"></img>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2Fmember_espejo.png?alt=media&token=52bcf390-6a7a-4e2f-b025-e51b00602ea6"></img>
                    <h2 class="text-lg font-medium">DOMINGO, Grace Ann I.</h2>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/LOOP-3fe00.appspot.com/o/About%20Us%2Fmember_miguel.png?alt=media&token=33eb870f-6166-44e5-8f51-c7f15dfbc63c"></img>
                    <h2 class="text-lg font-medium">ABRENICA, Yeshua Miguel B.</h2>
                    <p class="font-medium text-blue-500">Frontend Developer</p>
                  </div>
