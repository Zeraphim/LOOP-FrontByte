            ...
            <div class="bg-white h-full dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    <div>
                        ...
                        <a class="w-full text-gray-800 dark:text-white flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start border-l-4 border-purple-500" href="/map">
                            <span class="text-left">
